...
test('catalog covers every public AICC feature family', () => {
  ...
  for (const id of ['dashboard', 'status', 'codex', 'claude', 'ocx', 'accounts', 'workspace-mcp', 'workspace-publish', 'codex-agents', 'setup-check', 'cli-status', 'routes-status', 'support-bundle', 'web-gpt-doctor', 'ocx-diagnostics', 'guidance-check']) {
